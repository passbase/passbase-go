...
type ResourceInput struct {
	Type_ *ResourceType `json:"type,omitempty"`
	// 2-letter code of the country
	Country string `json:"country,omitempty"`
	ResourceFiles [][]ResourceFilesInputInner `json:"resource_files,omitempty"`
	ResourceData *interface{} `json:"resourceData,omitempty"`
	ResourceRawData *interface{} `json:"resourceRawData,omitempty"`
}
